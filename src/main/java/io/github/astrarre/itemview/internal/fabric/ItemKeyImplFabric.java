package io.github.astrarre.itemview.internal.fabric;
...
public class ItemKeyImplFabric implements ItemKey {
	...
	public ItemKeyImplFabric(@Nullable Item item, int count, @Nullable NBTagView tag) {
		if (count < 0) {
	...
	@Override
	public boolean areTagsEqual(ItemStack stack) {
		return this.areTagsEqual(FabricItemViews.view(stack));
	}
	...
	public boolean canStackWith(ItemStack stack) {
		return this.canStackWith(FabricItemViews.view(stack));
	}
